...
export const t6: PerformanceTask = {
  ...
  steps: [
    ...
    'Isolate the zone at the panel. With your teacher at the panel with you, open the enclosure, lift the zone pair off its terminals so you are reading the loop and not the panel, take the reading end to end and compare it against the end of line resistor value, then close the enclosure again before you walk the run.',
    ...
    'With your teacher at the panel again, open the enclosure, put the zone pair back on the terminals you lifted it from, close the enclosure, then take the zone out of isolation and confirm the panel shows it healthy with no fault light.',
