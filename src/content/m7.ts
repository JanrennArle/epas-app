  ...
  outcomes: [
    {
      ...
      lessons: [{
        ...
        blocks: [
          ...
          { kind: 'text', md: 'Work outward from the panel, proving one section at a time. Measure at the panel, then at the first junction, then further along, and each measurement tells you which side of that point the break is on. That is far quicker than opening every device in order.' },
      ...
      quiz: [
        ...
        { kind: 'mcq', id: 'm7-lo1-q2', competency: 'Perform the procedure in fire alarm system servicing.',
          ...
          answer: 2,
          rationale: [
            'The end of line resistor measures correctly, so the resistor and its connections are sound.',
            'The zone was disconnected at the panel for the first measurement, so the panel was not part of the circuit you measured.',
            'Correct. Looking outward from the first junction still reads open, so the break lies beyond that junction, and the end of line resistor measures correctly, so it is fitted and sound. That leaves the wiring between the first junction and the last device.',
            'A zone reading open at two separate points is a break.',
          ] },
