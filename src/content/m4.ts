  ...
  outcomes: [
    {
      ...
      lessons: [{
        ...
        blocks: [
          ...
          { kind: 'note', md: 'Measure an element cold, with the appliance unplugged. A 1000 watt element on 220 volts measures about 48 ohms. If you measure a few ohms, you are probably reading across the wrong pair of terminals.' },
        ],
      }],
      quiz: [
        ...
        { kind: 'mcq', id: 'm4-lo1-q3', competency: 'Discuss the procedures in servicing appliances with heating components.',
          stem: 'You measure 48 ohms across the element of a 1000 watt iron. What does that tell you?',
          options: [
          ...
          rationale: [
            ...
            'Correct. That is about what a 1000 watt element on 220 volts should read cold, so the element itself is fine and the fault is elsewhere.',
    ...
    },
    {
      ...
      lessons: [{
        ...
        blocks: [
          ...
          { kind: 'safety', md: 'A lithium cell cannot be switched off. Treat it as live whenever the case is open, never puncture or bend it, and never solder directly onto the cell body, because the heat can make it vent or catch fire. Fit replacements with their protection circuit intact. A cell that is swollen, hot, or hissing has already failed dangerously. Isolate it, never charge it, and never refit it.' },
      ...
      lessons: [{
        ...
        blocks: [
          ...
          { kind: 'steps', items: [
            ...
            'Unplug the charger and measure the cell, then measure it again with the lamp switched on.',
